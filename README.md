# Roblox-Joiner-Utility
A simple program designed mostly to serve its main purpose, that being detection of when you copy a link and using the private server's id to launch a `roblox://` protocol, skipping unnecessary wait times.

Here's what the app offers.

- **Almost** instant joining into any server simply by clicking the "copy" button and, well, copying the link to the clipboard!
